...
//    Route::get('/home', 'HomeController@index');
    ...
    Route::get('/user_edit', 'HomeController@user_edit');
    Route::post('/user_edit_info', 'HomeController@user_edit_info');
    Route::post('/user_edit_pass', 'HomeController@user_edit_pass');



    Route::get('/about', 'pubpagesController@about');
    Route::get('/faq', 'pubpagesController@faq');
    Route::get('/callus', 'pubpagesController@callus');
